...
|----------|-------------|--------|
| [PROJECT_MANAGEMENT.md](./PROJECT_MANAGEMENT.md) | Methodology, Linear workflow, GitFlow, releases, definition of done | Planned |
| [sprints/](./sprints/) | Sprint records and summary index | Planned |
...
| [adr/](./adr/) | Architecture Decision Records (ADRs) | Planned |
...
| [EXTERNAL_APIS.md](./EXTERNAL_APIS.md) | Upstream data sources (API Ninjas, Apify) | Planned |
